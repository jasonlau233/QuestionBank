...
class BottomDrag extends StatelessWidget {
  ...
  BottomDrag({Key key, @required this.body, @required this.dragContainer})
      : assert(body != null),
...
class DragContainer extends StatefulWidget {
  ...
  final double height;
  final bool needBound;

  DragContainer({Key key, @required this.drawer, @required this.defaultShowHeight, @required this.height, this.needBound = true})
      : assert(drawer != null),
