...
class ResponseError extends Error {
  ...
  ResponseError._init(this.status, {this.message});

  factory ResponseError.exception(Exception exception, {int status, String message}) {
    int code = status != null ? status : exception.value;
    String msg = message != null ? message : tupleCode[exception.value].msg;
    return ResponseError._init(code, message: msg);
  }
}

final Map<int, Tuple> tupleCode = {
