...
class CustomExpansionPanelList extends StatefulWidget {
  ...
  const CustomExpansionPanelList.radio(
      ...
      this.dividerColor,
      this.elevation = 2,
      this.bottomDividerColor = ColorUtils.color_bg_splitBlock})
      : assert(children != null),
        assert(animationDuration != null),
  ...
  Widget build(BuildContext context) {
    ...
    for (int index = 0; index < widget.children.length; index += 1) {
      ...
      Widget expandIconContainer = Container(
        ...
        margin: const EdgeInsetsDirectional.only(start: 12.0, end: 6),
        child: ExpandIcon(
          ...
          onPressed: !child.canTapOnHeader
              ...
              : null,
          disabledColor: ColorUtils.color_bg_theme,
        ),
      );
            ...
            children: <Widget>[
              Column(
                children: [
                  ...
                  Container(height: 12, color: widget.bottomDividerColor)
                ],
              ),
            ],
          ),
